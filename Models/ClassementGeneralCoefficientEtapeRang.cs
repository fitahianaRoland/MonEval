...
[Table("classement_general_coefficient_etape_rang")]
public class ClassementGeneralCoefficientEtapeRang
{
    ...
    [Column("point_coefficient")]
    public double? PointCoefficient { get; set; }

    [Column("rang_coefficient")]
    public int? RangCoefficient { get; set; }
